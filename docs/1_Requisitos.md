...
O sistema deve registrar ***pagamentos*** realizados na recepção (Meios de Pagamento) e gerar boletos para pagamentos online.
...
O sistema deve enviar ao aluno sobre vencimento de mensalidade, confirmação de agendamento e liberação de nova av. física.
